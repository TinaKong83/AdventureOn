...
public class AdventureTest {
    ...
    public void roomFromDirectionBadInput() {
        assertNull(adventure.getLayout().getRooms().get(0).roomFromDirection(null));
        assertNull(adventure.getLayout().getRooms().get(0).roomFromDirection("up!!"));
        assertNull(adventure.getLayout().getRooms().get(3).roomFromDirection(""));
        assertNull(adventure.getLayout().getRooms().get(7).roomFromDirection("go east"));
    }
